...
Webrat.configure do |config|
  ...
  # The next four are for Selenium.  Safari only works if you enable
  # preferences to allow pop-up windows.  Firefox doesn't work at all
  # even if you follow the directions to copy the system sqlite3 library
  # to the Firefox application directory.
